                ...
                <div class="row">
                    ...
                    <div
                        ...
                        <div class="card card-primary logincard">
                            ...
                            <div class="card-body">
                                <form method="POST" action="../API/transferMoney.php" class="needs-validation">
                                    <input type="hidden" name="_token" value="Iy0FRDBOIkaUKE25aJqtOAIIZbsRA1D2wpZGbg4r">

                                    <div class="form-group">
                                        <label for="recipientEmail">Recipient's Email</label>
                                        <input id="recipientEmail" type="email" class="form-control"
                                            name="recipientEmail" tabindex="1" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="amount">Amount</label>
                                        <input id="amount" type="text" class="form-control" name="amount" tabindex="2"
                                            required>
                                    </div>
